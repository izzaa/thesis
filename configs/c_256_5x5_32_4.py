...
def get_basic_layer(prev_layer_name, index, n, stride) :
    basic_layer = [
        (Conv2DLayer, conv_params("Conv2DLayer_" + str(index), n)),
        (Conv2DLayer, conv_params("Conv2DLayer_" + str(index+1), 2 * n, stride=stride)),
...
def get_all_layer() :
    layers = [
        ...
        (Conv2DLayer, conv_params("Conv2DLayer_1", n, filter_size=(7, 7), stride=(2, 2))),
