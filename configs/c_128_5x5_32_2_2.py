...
layers = [
    ...
    (Conv2DLayer, conv_params(n, name="Conv2DLayer_2_a")),
    (ConcatLayer, {'incomings':["Conv2DLayer_1", "Conv2DLayer_2_a"]}),
    ...
    (Conv2DLayer, conv_params(4 * n, name="Conv2DLayer_9")),
    (Conv2DLayer, conv_params(4 * n, name="Conv2DLayer_10")),
    (Conv2DLayer, conv_params(4 * n, name="Conv2DLayer_11")),
    (ConcatLayer, {'incomings': ["Conv2DLayer_9", "Conv2DLayer_11"]}),
