...
layers = [
    ...
    (Conv2DLayer, conv_params(2 * n, name="Conv2DLayer_3_a", filter_size=(5, 5), stride=(2, 2))),
    (Conv2DLayer, conv_params(2 * n, name="Conv2DLayer_4_a")),
    (Conv2DLayer, conv_params(2 * n, name="Conv2DLayer_5_a")),
    (ConcatLayer, {'incomings':["Conv2DLayer_3_a", "Conv2DLayer_5_a"]}),
    (MaxPool2DLayer, pool_params()),
